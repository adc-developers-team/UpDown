...
function App() {
  ...
  if (loading) return <div className="h-screen bg-chat-bg flex items-center justify-center text-primary"><div className="animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-light-blue"></div></div>;
  return (
    <Routes>
